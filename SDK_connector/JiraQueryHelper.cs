...
namespace SDK_connector
{
    public class JiraQueryHelper
    {
        ...
        public static Jira? jira = Jira.CreateRestClient(uri, userName, apiKey);

        public static async Task<IEnumerable<Project>?> GetAllProjects()
        {
            return await jira.Projects.GetProjectsAsync();
        }
    }
}